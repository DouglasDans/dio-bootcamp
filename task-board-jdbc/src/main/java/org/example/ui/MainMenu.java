...
import static org.example.persistence.entity.BoardColumnKind.*;
...
public class MainMenu {
    ...
    private BoardColumn createColumn(final String name, final BoardColumnKind kind, final int order){
